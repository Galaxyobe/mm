...
class RedisMixin(object):
    ...
    def next_requests(self):
        ...
        is_zset = self.settings.getbool(
            'REDIS_START_URLS_IS_ZSET',
            False)
        ...
        if not is_zset:
            ...
            pipe.zrange(self.redis_key,
                        0,
                        self.redis_batch_size,
                        withscores=True).zremrangebyrank(self.redis_key,
                                                         0,
                                                         self.redis_batch_size)
